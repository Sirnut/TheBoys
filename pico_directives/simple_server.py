...
<button id="testOn"> On </button>
<button id="testOff"> Off </button>
<p>%s</p>
</body>
<script>
const turnOn = () => {
    fetch("/?led=on")
    .then(response => console.log("turned on"))
};

const turnOff = () => {
    fetch("/?led=off")
    .then(response => console.log("turned off"))
};

document.getElementById("testOn").addEventListener("click", turnOn);
document.getElementById("testOff").addEventListener("click", turnOff);
</script>
</html>
"""
